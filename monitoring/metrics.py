...
"""
Prometheus Metrics for Central Bank Speech Analysis Platform

Defines, exposes, and updates core platform metrics for observability.
Call `start_metrics_server()` early in app startup to expose /metrics.
...
# Example usage:
# from monitoring.metrics import start_metrics_server, record_collection_success
